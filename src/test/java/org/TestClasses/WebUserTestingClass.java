...
public class WebUserTestingClass extends BasePage {
    ...
    // Done with assertion error on idle time  expected [00:00:00] but found [-]
    ...
    public void testReportSystemActivityFunctionality() {
        ...
        //Verify user should able to see current date all used url & App when loading the page first time
        logger.info("TC_22 "+"Verify user should able to see current date all used url & App when loading the page first time !");
        logger.info("TC_23 "+"Veify that first activity of the user should have start time as day start time !");

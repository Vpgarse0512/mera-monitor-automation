...
public class FiveTilesDataEndPoint extends RestUtils {
    ...
    public HashMap<String, Object> getFiveTilesDataMap()
    {
        ...
        map.put("totalHours",TimeDateClass.convertSecondsToHHMMSSFormat(Double.parseDouble(tiles.getString("totalTime"))));
        map.put("activeTime",TimeDateClass.convertSecondsToHHMMSSFormat(Double.parseDouble(tiles.getString("totalActiveTime"))));
        map.put("idleTime",TimeDateClass.convertSecondsToHHMMSSFormat(Double.parseDouble(tiles.getString("totalIdleTime"))));
        map.put("awayTime",TimeDateClass.convertSecondsToHHMMSSFormat(Double.parseDouble(tiles.getString("awayTime"))));
        String[] first = tiles.getString("firstActivity").split(" ");
        map.put("firstActivity",first[1]+" "+first[2]);
        String[] last = tiles.getString("lastActivity").split(" ");
        map.put("lastActivity",last[1]+" "+last[2]);
